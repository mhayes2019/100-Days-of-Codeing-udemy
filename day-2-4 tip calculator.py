...
#assignment calls for the decimal to be rounded two places so here the round() is used and it is calling to move 2 spaces, also need to use the {:.2f} format to make sure that all numbers 2 places after the decimal will appear 
final_total_bill = round (new_total_bill, 2)
final_total_bill = "{:.2f}".format(new_total_bill)
